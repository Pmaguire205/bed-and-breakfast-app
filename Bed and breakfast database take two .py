...
##      Search icon
        ...
        self.search_frame = Frame(self.gf_window, bg="#e2f0d9", width = 900, height= 400)
        self.search_frame.place(x=25, y=400)

        #Frame for search entry2 
        self.search_frame2 = Frame(self.gf_window, bg="white", width = 900, height= 100)
        self.search_frame2.place(x=10, y=295)
...
##      delete button
        ...
        self.delete_button = Button(self.gf_window,image = self.delete_guest_photo,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0,command = self.guest_delete)
...
##      Save button
        ...
        self.save_guest_icon = self.save_guest_icon_resize
        self.save_guest_photo = ImageTk.PhotoImage(self.save_guest_icon)
        self.sg_label = Label(self.ga_window,image =self.save_guest_photo ,bg = "#c4dfb4")
        self.sg_label.image = self.save_guest_photo
        self.sg_button = Button(self.ga_window, image = self.save_guest_photo,command = self.save,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0)
        self.sg_button.place(x=1125, y=500)
...
##      Edit button
        ...
        self.eg_label.image = self.edit_guest_photo
        self.edit_button = Button(self.ga_window,command = self.guest_edit,image = self.edit_guest_photo,cursor = "hand2",bg = "#a8d18e",borderwidth = 0)
        self.edit_button.place(x=975,y=500)
...
##      delete button
        ...
        self.delete_guest_icon = self.delete_guest_icon_resize
        self.delete_guest_photo = ImageTk.PhotoImage(self.delete_guest_icon)
        self.dg_label = Label(self.ga_window,image =self.delete_guest_photo ,bg = "#c4dfb4")
        self.dg_label.image = self.delete_guest_photo
        self.delete_button = Button(self.ga_window,command = self.guest_delete,image = self.delete_guest_photo,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0)
        self.delete_button.place(x=1275,y=500)
...
##      New guest record heading 
        self.guest_heading_image = Image.open("edit guest records.png")
        self.guest_heading_image_resize = self.guest_heading_image.resize((400,75))
        self.guest_heading_image = self.guest_heading_image_resize
        photo_guest_heading = ImageTk.PhotoImage(self.guest_heading_image)
...
##      Save button
        ...
        self.save_guest_icon = self.save_guest_icon_resize
        self.save_guest_photo = ImageTk.PhotoImage(self.save_guest_icon)
        self.sg_label = Label(self.ge_window,image =self.save_guest_photo ,bg = "#c4dfb4")
        self.sg_label.image = self.save_guest_photo
        self.sg_button = Button(self.ge_window, image = self.save_guest_photo,command = self.guest_add,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0)
        self.sg_button.place(x=1125, y=500)
...
##      Edit button
        ...
        self.eg_label.image = self.edit_guest_photo
        self.edit_button = Button(self.ge_window,command = self.edit,image = self.edit_guest_photo,cursor = "hand2",bg = "#a8d18e",borderwidth = 0)
        self.edit_button.place(x=975,y=500)
...
##      delete button
        ...
        self.delete_guest_icon = self.delete_guest_icon_resize
        self.delete_guest_photo = ImageTk.PhotoImage(self.delete_guest_icon)
        self.dg_label = Label(self.ge_window,image =self.delete_guest_photo ,bg = "#c4dfb4")
        self.dg_label.image = self.delete_guest_photo
        self.delete_button = Button(self.ge_window,image = self.delete_guest_photo,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0,command = self.guest_delete)
        self.delete_button.place(x=1275,y=500)
...
##      User icon
    ...
    def guest_delete(self):
        ...
        self.gd_window= Tk()
        self.gd_window.geometry("1400x850")
        self.gd_window.title("Edit Guests")
        self.gd_window.configure(bg = "white")
        #To zoom the page 
        self.gd_window.state("zoomed")
        self.gd_window.resizable(0,0)

        #right hand side image
        shape_image1 = Image.open("shape design.png")
        photo2 = ImageTk.PhotoImage(shape_image1)
        label2= Label(self.gd_window,image = photo2)
        label2.image = photo2
        label2.place(x=950, y=0,height = 1000)
        
##      New guest record heading 
        self.guest_heading_image = Image.open("delete guest records.png")
        self.guest_heading_image_resize = self.guest_heading_image.resize((400,75))
        self.guest_heading_image = self.guest_heading_image_resize
        photo_guest_heading = ImageTk.PhotoImage(self.guest_heading_image)
        self.guest_label = Label(self.gd_window,image = photo_guest_heading)
        self.guest_label.image = photo_guest_heading
        self.guest_label.place(x=150, y=0,height = 75)

        #Frame for entry details for new guest 
        self.new_guest_frame = Frame(self.gd_window, bg="white", width = 700, height= 700)
        self.new_guest_frame.place(x=100, y=150)
...
##      Save button
        ...
        self.save_guest_icon = self.save_guest_icon_resize
        self.save_guest_photo = ImageTk.PhotoImage(self.save_guest_icon)
        self.sg_label = Label(self.gd_window,image =self.save_guest_photo ,bg = "#c4dfb4")
        self.sg_label.image = self.save_guest_photo
        self.sg_button = Button(self.gd_window, image = self.save_guest_photo,command = self.guest_add,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0)
        self.sg_button.place(x=1125, y=500)

        self.sg_heading = Label(self.gd_window, text = "Add", font = ("Avenir Next",20),bg = "#c4dfb4")
        self.sg_heading.place(x=1160, y= 585)
...
##      Edit button
        ...
        self.edit_guest_icon = self.edit_guest_icon_resize
        self.edit_guest_photo = ImageTk.PhotoImage(self.edit_guest_icon)
        self.eg_label = Label(self.gd_window,image =self.edit_guest_photo ,bg = "#a8d18e")
        self.eg_label.image = self.edit_guest_photo
        self.edit_button = Button(self.gd_window,command = self.guest_edit,image = self.edit_guest_photo,cursor = "hand2",bg = "#a8d18e",borderwidth = 0)
        self.edit_button.place(x=975,y=500)

        self.eg_heading = Label(self.gd_window, text = "Edit", font = ("Avenir Next",20),bg = "#a8d18e")
        self.eg_heading.place(x=1010, y= 585)
...
##      delete button
        ...
        self.delete_guest_icon = self.delete_guest_icon_resize
        self.delete_guest_photo = ImageTk.PhotoImage(self.delete_guest_icon)
        self.dg_label = Label(self.gd_window,image =self.delete_guest_photo ,bg = "#c4dfb4")
        self.dg_label.image = self.delete_guest_photo
        self.delete_button = Button(self.gd_window,image = self.delete_guest_photo,cursor = "hand2",bg = "#c4dfb4",borderwidth = 0,command = self.DeleteGuest)
        self.delete_button.place(x=1275,y=500)

        self.dg_heading = Label(self.gd_window, text = "Delete", font = ("Avenir Next",20),bg = "#c4dfb4")
        self.dg_heading.place(x=1310, y= 585)
...
##      Back button
        ...
        self.back_icon = self.back_icon_resize
        self.back_photo = ImageTk.PhotoImage(self.back_icon)
        self.back_label = Label(self.gd_window,image =self.back_photo ,bg = "#e2f0d9")
        self.back_label.image = self.back_photo
        self.back_button = Button(self.gd_window,image = self.back_photo,command = self.back_delete_guess,cursor = "hand2",bg = "white",borderwidth = 0)
        self.back_button.place(x=1082,y=640,width = 200, height = 62)
...
##      User icon
        ...
        self.guest_icon = self.guest_icon_resize
        self.guest_icon_photo = ImageTk.PhotoImage(self.guest_icon)
        self.gi_label = Label(self.gd_window,image =self.guest_icon_photo ,bg = "#a8d18e")
        self.gi_label.image = self.guest_icon_photo
        self.gi_label.place(x=1100,y=225)
    ...
    def Search(self,Event):
        ...
        search_fields = ["guestFirstname","guestSurname"]
